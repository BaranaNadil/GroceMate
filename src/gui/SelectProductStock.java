...
public class SelectProductStock extends javax.swing.JDialog {
    ...
    public SelectProductStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("S e l e c t   P r o d u c t   S t o c k");
...
//                    jButton1.grabFocus();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectProductStock dialog = new SelectProductStock(new javax.swing.JFrame(), true);
